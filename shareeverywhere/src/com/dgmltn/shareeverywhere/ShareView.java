...
public class ShareView extends ViewGroup implements ActivityChooserModelClient {
    ...
    public interface OnShareTargetSelectedListener {
        /**
         *
         * @param view the ShareView
         * @param intent the intent to launch, you <strong>may</strong> modify this to control what
         *               is shared.
         * @return true if you want to launch the intent, false if you are handling it yourself.
         */
        boolean onShareTargetSelected(ShareView view, Intent intent);
    }
                ...
                case ActivityChooserViewAdapter.ITEM_VIEW_TYPE_ACTIVITY: {
                    ...
                    if (mIsSelectingDefaultActivity) {
                        ...
                        if (launchIntent != null) {
                            ...
                            if (mListener != null) {
                                shouldStart = mListener.onShareTargetSelected(ShareView.this, launchIntent);
                            }
